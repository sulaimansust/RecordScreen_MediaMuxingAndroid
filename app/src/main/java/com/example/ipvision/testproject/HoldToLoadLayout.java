...
//                mainActivity.initRecorder();
                mainActivity.rawFile = mainActivity.recordScreen.getFile("raw");
                mainActivity.videoFile = mainActivity.recordScreen.getFile("mp4");
                mainActivity.initMediaRecorder(mainActivity.videoFile);
                isFilling = true;
                invalidate();
                break;
            case MotionEvent.ACTION_UP:
                isFilling = false;
//                mainActivity.destroyMediaProjection();
//                mainActivity.addPreviewFragment();
                mainActivity.destroyMedia();
                invalidate();
                break;
            default:
                break;
...
//        Log.d(TAG,"stopForwardColorAnimator");
